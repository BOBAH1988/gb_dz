...
# hours, stav, bonus = map(float, argv[1:])
# print(f'Расчет ЗП: Часов отработано: {hours}, Ставка: {stav}, Премия: {bonus}, Итого: {hours * stav + bonus} рублей.')
...
# my_list = [number for el, number in enumerate(n) if el > 0 and n[el] > n[el - 1]]
# print(my_list)
...
# print([el for el in n if n.count(el) == 1])
...
# n = [el for el in range(100, 1001) if el % 2 == 0]
# def func(i, el):
#     return i * el
# print(reduce(func, n))
...
#     for i in islice(count(n), 10):
#         print(i)
# fun1()
#
# def fun2():
#     my_list = [0.1, 1, 'Один', True]
